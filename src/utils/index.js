...
export const formatCardNumber = (number) => {
  ...
  switch (cardType) {
    case "amex":
      formatNumber = `${numberCleared.slice(0, 4)} ${numberCleared.slice(
        4,
        10
      )} ${numberCleared.slice(10, 15)}`;
      break;
    case "dinersclub":
      formatNumber = `${numberCleared.slice(0, 4)} ${numberCleared.slice(
        4,
        10
      )} ${numberCleared.slice(10, 14)}`;
      break;
    default:
      formatNumber = `${numberCleared.slice(0, 4)} ${numberCleared.slice(
        4,
        8
      )} ${numberCleared.slice(8, 12)} ${numberCleared.slice(12, 19)}`;
      break;
  }
