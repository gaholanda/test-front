...
import { GridItem, Container, Title, Message, Box, Image, CardInfo } from '../styles';
      ...
      { !purchase.products && <Redirect to="/" /> }
      {
        ...
        <Fragment>
          <GridItem area="message" padding={16}>
            <Image width={40} height={40} src="/images/success.png" alt="Compra efetuada"/>
            <Message color="#FF7800" fontSize={14} fontWeight="bold" textAlign="center" margin="10px 0 0">
